    ...
    , ui(new Ui::MainWindow)
{
    ...
    _nameButton = {"Language", "Theme", "Font", "<", "-" ,">" ,"==", "CF" ,"VF", "Time And Date"};
...
void MainWindow::slotSet()
{
    ...
    if(buttonName == _nameButton[9])
    {
        _timeDate = QDateTime::currentDateTime();
        ui->textEdit->textCursor().insertText(_timeDate.toString("h:m:s ap ddd MMMM d yy"));
